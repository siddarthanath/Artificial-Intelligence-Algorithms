"""
This file creates a Long Short-Term Memory Network (LSTM).
This RNN has been trained and tested on the Mastercard Stock dataset.
This means that the for other datasets, the LSTM architecture and output prediction conversion may need alterting.
"""
# -------------------------------------------------------------------------------------------------------------------- #
# Standard Library
