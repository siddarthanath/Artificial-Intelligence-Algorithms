...
This CNN has been trained and tested on the MNIST dataset.
This means that the for other datasets, the CNN architecture and output prediction conversion may need alterting.
"""
# -------------------------------------------------------------------------------------------------------------------- #
# Standard Library
...
class CNN(nn.Module):
    ...
    """This fits the CNN to the training set and evaluates the CNN on the validation set."""
